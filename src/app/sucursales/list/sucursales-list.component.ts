        ...
        <div class="table-responsive">
          <table mat-table [dataSource]="data()" class="full-table">
            ...
            <ng-container matColumnDef="principal">
              ...
              <td mat-cell *matCellDef="let item">
                <mat-chip highlighted>{{ item.es_principal ? 'Sí' : 'No' }}</mat-chip>
              </td>
            </ng-container>
...
export default class SucursalesListComponent extends BaseListComponent<Sucursal> {
  ...
  protected override loadService(
    page: number,
    limit: number,
  ): Observable<{ data: Sucursal[]; total: number }> {
  ...
  protected override getId(item: Sucursal): number | string {
    return item.idsucursal!;
  }
  protected override getDisplayName(item: Sucursal): string {
    return item.nombre;
  }
}
