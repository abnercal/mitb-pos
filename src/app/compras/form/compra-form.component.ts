      ...
      <mat-dialog-content>
        <div class="form-row">
          <mat-form-field appearance="fill" class="flex-2">
            ...
            <input matInput formControlName="nombre" placeholder="Ej: OC-001" autocomplete="off">
...
export class CompraFormComponent implements OnInit {
  ...
  readonly detalles = signal<{ codigoprod: number; nombre: string; cantidad: number; costo: number }[]>([]);
  readonly detalleColumns = ['producto', 'cantidad', 'costo', 'subtotal', 'accion'];
  ...
  ngOnInit(): void {
    this.proveedorService.getAll().subscribe(r => this.proveedores = r);
